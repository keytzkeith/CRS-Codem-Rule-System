<template>
  <div class="crs-page space-y-8">
    ...
    <section class="crs-stat-grid">
      ...
      <MetricCard label="Average RR" :value="`${metrics.averageRR}:1`" hint="Average win / average loss" info="Average reward-to-risk based on average winning PnL divided by average losing PnL in the current dataset." />
