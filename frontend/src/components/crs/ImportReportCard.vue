<template>
  <div v-if="duplicates.length || invalidRows.length" class="rounded-[24px] border border-white/8 bg-slate-950/25 p-5">
...
function downloadReport() {
  const csv = buildImportIssuesCsv(props.duplicates, props.invalidRows)
