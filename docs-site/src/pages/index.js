...
auth      : local + admin-capable`}</pre>
        ...
        <section className="crs-founder">
          ...
          <div className="crs-founder__copy">
            <p className="crs-kicker">Created by Keith Odera</p>
            <h2>Founder &amp; Developer of CRS</h2>
            <p>
              Keith Odera is a Kenya-based builder focused on turning trading workflow ideas into
            ...
            <div className="crs-actions">
              ...
              <a className="button button--secondary button--lg" href="https://keytz-portfolio.vercel.app/" target="_blank" rel="noreferrer">
                View portfolio
              </a>
            </div>
            <div className="crs-founder__links">
              <a href="mailto:codemtrader@gmail.com">
                <MailIcon />
                <span>codemtrader@gmail.com</span>
              </a>
              <a href="https://keytz-portfolio.vercel.app/" target="_blank" rel="noreferrer">
                <GlobeIcon />
                <span>Portfolio</span>
              </a>
              <a href="https://github.com/keytzkeith/CRS-Codem-Rule-System/" target="_blank" rel="noreferrer">
                <GitHubIcon />
                <span>GitHub</span>
              </a>
            </div>
