...
-- Allows CRS to act as an identity provider for external applications like Discourse
...
COMMENT ON TABLE oauth_clients IS 'OAuth2 clients (applications) that can authenticate users via CRS';
